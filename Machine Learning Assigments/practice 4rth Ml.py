...
print(df.info())
df.plot.scatter(x='length',y='width', title= 'scatter plot of length and width percentage')
plt.show()
...
print("df['length']:",df['length'])
print("df['width']:",df['width'])
...
print(df['width'].values)
print(df['length'].values.shape)

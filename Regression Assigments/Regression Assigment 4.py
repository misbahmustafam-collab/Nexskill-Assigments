...
df.plot.scatter(
    ...
    title='total_bedrooms vs housing_median_age'
)
...
print("Minimum housing_median_age:", df['housing_median_age'].min())
print("Maximum housing_median_age:", df['housing_median_age'].max())
...
print("y:")
print(y)
df = df.dropna(subset=['total_bedrooms', 'housing_median_age'])

print(df['total_bedrooms'].values) # [2.5 5.1 3.2 8.5 3.5 1.5 9.2 ... ]
print(df['total_bedrooms'].values.shape) # (25,)
...
variables = ['Present_Price', 'housing_median_age']
...
import matplotlib.pyplot as plt
print(df.columns.tolist())
variables = ['total_bedrooms', 'housing_median_age']

for var in variables:
    sns.regplot(x=var, y='total_bedrooms', data=df)
    plt.title(f'Regression Plot of {var} and total_bedrooms')
    plt.show()
...
# Features and Target
X = df[['total_bedrooms', 'housing_median_age']]
y = df['total_bedrooms']
